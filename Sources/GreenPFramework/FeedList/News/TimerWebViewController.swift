...
class TimerWebViewController : WebViewController {
    ...
    private lazy var tap = UITapGestureRecognizer(target: self, action: #selector(gestureDidBegin(_:)))
    private lazy var pan = UIPanGestureRecognizer(target: self, action: #selector(gestureDidBegin(_:)))
